...
# -*- coding: utf-8 -*-
#
# experiment_widgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'experiment_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'experiment_widgetsdoc'
...
latex_documents = [
    (master_doc, 'experiment_widgets.tex', 'experiment_widgets Documentation',
     '', 'manual'),
]
...
man_pages = [
    (master_doc,
    'experiment_widgets',
    'experiment_widgets Documentation',
     [author], 1)
]
